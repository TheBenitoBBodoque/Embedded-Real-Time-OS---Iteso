...
*
*   Description: Interrupt service routine vectors
*
*
*   Revision History:
*
...
void (* near const vectors[])(void) @ 0xFF10 =
{
  ...
  vfnPIT_Channel3_Isr,          /* 0x3A  0xFF74 ivVpit3           */
  vfnPIT_Channel2_Isr,          /* 0x3B  0xFF76 ivVpit2           */
  vfnPIT_Channel1_Isr,          /* 0x3C  0xFF78 ivVpit1           */
  vfnPIT_Channel0_Isr,   /*  vfnPIT_Channel0_Isr 0x3D  0xFF7A ivVpit0             */
