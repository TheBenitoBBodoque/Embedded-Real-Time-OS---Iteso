...
/**
* \brief    Callback handled once an interrupt is generated by Channel 1.
* \author   Esteban Bernardo, Jose Miguel Reyes, Sergio Pineda
* \param    None  
* \return   void
* \details  \b Reentrancy Non Reentrant  
...
/**
* \brief    Callback handled once an interrupt is generated by Channel 2.
* \author   Esteban Bernardo, Jose Miguel Reyes, Sergio Pineda
* \param    None  
* \return   void
* \details  \b Reentrancy Non Reentrant  
...
/**
* \brief    Callback handled once an interrupt is generated by Channel 3.
* \author   Esteban Bernardo, Jose Miguel Reyes, Sergio Pineda
* \param    None  
* \return   void
* \details  \b Reentrancy Non Reentrant  
